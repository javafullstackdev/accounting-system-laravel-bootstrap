        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              {!! Form::text('ref_number', null, ['class' => 'form-control', 'placeholder' => __('product.ref_number'), 'required']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-4 hide" id="alert_quantity_div">
            <div class="form-group">
              ...
              {!! Form::number('alert_quantity', 0, ['class' => 'form-control', 'required',
    ...
    <div class="box box-solid">
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="form-group">
              {!! Form::label('currency_country', __('currencies.currency') . ':*') !!}
              {!! Form::select('currency_country', $currencies, $default_currency_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
            </div>
          </div>
          ...
          {{--<div class="col-sm-4">--}}
            {{--<div class="form-group">--}}
              ...
              {{--{!! Form::text('currency_rate', null, ['class' => 'form-control', 'readonly', 'required']); !!}--}}
            {{--</div>--}}
          {{--</div>--}}
...
{{--          {!! Form::select('currency_rates', $currencies['currency_rate'], null, ['type' => 'hidden']) !!}--}}
          <div class="col-sm-12">
            <input type="hidden" name="submit_type" id="submit_type">
            <div class="pull-right">
              <button id="opening_stock_button" type="submit" value="submit_n_add_opening_stock" class="btn btn-success submit_product_form hide">@lang('lang_v1.save_n_add_opening_stock')</button>&nbsp;&nbsp;

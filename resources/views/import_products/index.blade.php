            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>2</td>
                            <td>@lang('product.ref_number') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                            <td>@lang('lang_v1.product_ref_no')</td>
                        </tr>
                        <tr>
                            <td>3</td>
                        ...
                        <tr>
                            <td>8</td>
                            <td>@lang('lang_v1.purchase_price_exc_tax')   <small class="text-muted">(@lang('lang_v1.required'))</small></td>

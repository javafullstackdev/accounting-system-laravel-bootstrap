  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @endif
          ...
          @if(auth()->user()->can('purchase.view') || auth()->user()->can('purchase.create') )
              <li class="{{ $request->segment(1) == 'inventory' ? 'active' : '' }}" >
                  <a href="{{action('BusinessLocationController@index')}}"><i class="fa fa-database"></i> @lang('inventory.inventory')</a>
              </li>
          @endif
          @if(auth()->user()->can('purchase.view') || auth()->user()->can('purchase.create') )
        ...
        @if (auth()->user()->can('purchase.view') && auth()->user()->can('sell.view') && auth()->user()->can('expense.access'))
          <li class="{{ $request->segment(1) == 'bank' ? 'active' : '' }}" id="bank">
              <a href="{{ action('BankController@index') }}" id="bank">
                  <i class="fa fa-save"></i> <span>@lang('bank.bank')</span>
              </a>
          </li>
        @endif
        ...
        <li class="{{ $request->segment(1) == 'currencies' ? 'active' : '' }}" id="currency">
          <a href="{{ action('CurrencyController@index') }}" id="currency">
              <i class="fa fa-dollar"></i> <span>@lang('currencies.currency')</span>
          </a>
        </li>
                  ...
                  @can('user.create')
                      <li class="{{ $request->segment(1) == 'roles' ? 'active active-sub' : '' }}">
                          <a href="{{action('RoleController@index')}}">
                              ...
                              <span class="title">@lang('user.roles')</span>
                          </a>
                      </li>
        ...
        auth()->user()->can('user.view') || auth()->user()->can('user.create'))

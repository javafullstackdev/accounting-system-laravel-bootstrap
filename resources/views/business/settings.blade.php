...
{{--                                    {!! Form::select('date_format', $date_formats, 'd/m/Y', ['class' => 'form-control select2', 'required']); !!}--}}
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('default_sales_discount', null, ['class' => 'form-control', 'min' => 0, 'step' => 0.01, 'max' => 100]); !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('item_addition_method', [ 0 => __('lang_v1.add_item_in_new_row'), 1 =>  __('lang_v1.increase_item_qty')], 1, ['class' => 'form-control select2']); !!}
                            </div>
                        </div>

    ...
    <div class="box box-solid"> 
        ...
        <div class="box-body">
                ...
                <div class="col-sm-4 @if(!$business->enable_product_expiry) hide @endif" id="on_expiry_div">
                    <div class="form-group">
                        <div class="multi-input">
                            ...
                            {!! Form::select('on_product_expiry', ['keep_selling'=>__('lang_v1.keep_selling')], $business->on_product_expiry, ['class' => 'form-control pull-left', 'style' => 'width:60%;']); !!}
                            ...
                            {!! Form::number('stop_selling_before', 0, ['class' => 'form-control pull-left', 'placeholder' => 'stop n days before', 'style' => 'width:40%;', $disabled, 'required', 'id' => 'stop_selling_before']); !!}
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="hide col-sm-4 enable_sub_category @if($business->enable_category != 1) hide @endif">
                    <div class="form-group">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('enable_sub_category', 1, 0, [ 'class' => 'input-icheck', 'id' => 'enable_sub_category']); !!} {{ __( 'lang_v1.enable_sub_category' ) }}
                          </label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 hide">
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                {{--{!! Form::checkbox('enable_price_tax', 1, $business->enable_price_tax, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_price' ) }}--}}
                                {!! Form::checkbox('enable_price_tax', 1, 1, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_price' ) }}
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row hide">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('enable_racks', 1, 0, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_racks' ) }}
                          </label>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('enable_row', 1, 0, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_row' ) }}
                          </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('enable_position', 1, 0, [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_position' ) }}
                          </label>
                        </div>
                    </div>
                </div>

...
<section class="content no-print">
	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('location_id', __('lang_v1.inventory_from').':*') !!}
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('transfer_location_id', __('lang_v1.inventory_to').':*') !!}
	...
	<div class="box box-solid">
		<div class="box-header">
        	<h3 class="box-title">{{ __('stock_adjustment.select_products') }}</h3>
       	</div>
		<div class="box-body">
			<div class="row">
					...
					<div class="form-group">
						<div class="input-group">
							...
							{!! Form::select('available_product_list',
								array(), null, ['class' => 'form-control select2', 'id' => 'available_product_list', 'placeholder' => __('stock_adjustment.search_product'), 'required']); !!}
						</div>
					</div>
				</div>
				{{--<div class="col-sm-8 col-sm-offset-2">--}}
					{{--<div class="form-group">--}}
						{{--<div class="input-group">--}}
							...
							{{--</span>--}}
							{{--{!! Form::text('search_product', null, ['class' => 'form-control', 'id' => 'search_product_for_srock_adjustment', 'placeholder' => __('stock_adjustment.select_product'), 'disabled']); !!}--}}
						{{--</div>--}}
					{{--</div>--}}
				{{--</div>--}}
			</div>
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					...
					id="stock_adjustment_product_table">
						...
						<tfoot>
							<tr class="text-center"><td colspan="4"></td><td><div class="pull-right"><b>@lang('stock_adjustment.total_amount'):</b> <span id="total_adjustment">0.00</span></div></td></tr>
						</tfoot>
					</table>
					</div>
				</div>

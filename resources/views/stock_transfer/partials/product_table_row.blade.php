<tr class="product_row" data-row_index="{{$row_count}}">
    ...
    <td>
        {{--<input type="hidden" readonly name="products[{{$row_count}}][unit_price]" class="form-control product_unit_price" value="{{@num_format($product->purchase_price)}}">--}}
        <input type="text" readonly name="products[{{$row_count}}][unit_price]" class="form-control product_unit_price" value="{{@num_format($product->purchase_price)}}">
        {{--<input type="text" readonly class="form-control product_unit_price" value="{{@num_format($product->dsp)}}">--}}
    </td>
    ...
    <td class="text-center v-center">
        <input type="text" readonly name="products[{{$row_count}}][price]" id="product_line_total" data-currency_symbol="true" class="form-control display_currency product_line_total" value="{{@num_format($product->quantity_ordered * $product->purchase_price )}}">
    </td>

        ...
        <div class="col-md-12">
            <div class="box box-primary" id="accordion">
                ...
                <div id="collapseFilter" class="panel-collapse active collapse in" aria-expanded="true">
                    <div class="box-body">
                        {!! Form::open(['url' => action('PurchaseController@index'), 'method' => 'get', 'id' => 'filter_form' ]) !!}
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('purchase_status', $purchase_status, null, ['placeholder' => __('messages.all'), 'class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'purchase_status']); !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            	...
            	<table class="table table-bordered table-striped ajax_view" id="purchase_table">
            		<thead>
            			<tr>
                            ...
                            <th>@lang('inventory.inventory')</th>

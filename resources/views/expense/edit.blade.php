      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('bank_id', $banks, $expense->bank_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('exchange_rate_list','Currency :*') !!}
            {!! Form::select('exchange_rate_list', $currencies, $default_currency_id, ['class' => 'form-control select2', 'required', 'id'=>'row_currency_rate']); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">

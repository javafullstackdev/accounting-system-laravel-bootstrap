	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="input-group">
				...
				{!! Form::text("payment[$row_index][amount]", @num_format($payment_line['amount']), ['class' => 'form-control payment_amount input_number', 'required', 'id' => "pay_amount", 'placeholder' => __('sale.amount')]); !!}
			</div>
		</div>
	</div>
	<div class="col-md-6">

			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class="input-group">
							...
							{!! Form::select('contact_id', $contact_ids, null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::select('invoice_no', array(), null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('bank_name', __('bank.bank') . ':*') !!}
						{!! Form::text('bank_name', null, ['class' => 'form-control', 'placeholder' => 'None', 'readonly', 'required']); !!}
					</div>
				</div>

				{{ Form::hidden('bank_id', 0, ['id' => 'bank_id']) }}
			</div>
		</div>
	</div> <!--box end-->

...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
				...
				<div class="box-body">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<div class="input-group">
								...
								{!! Form::select('select_location_id', $business_locations, null, ['class' => 'form-control select2 input-sm',
					...
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
						<div class="form-group">
							...
							{!! Form::select('bank_id', $banks, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
						</div>
					</div>
				</div>
				<!-- /.box-body -->
						...
						<div class="form-group">
							<div class="input-group">
								...
								{!! Form::select('available_product_list',
									$available_product_list, null, ['class' => 'form-control select2', 'id' => 'available_product_list', 'placeholder' => 'Select Product For Sale', 'required']); !!}
							</div>
						</div>
					</div>
	...
	<!--box end-->
	<div class="box box-solid hide" id="payment_rows_div"><!--box start-->

...
return [
	...
	'all_stock_transfers' => 'All Inventory Transfers',
	'add_stock_transfer' => 'Add Inventory Transfer',
	'list_stock_transfers' => 'List Inventory Transfers',
	'location_from' => 'Inventory (From)',
	'location_to' => 'Inventory (To)',
    'inventory_from' => 'Inventory (From)',
    'inventory_to' => 'Inventory (To)',
	'shipping_charges' => 'Shipping Charges',
	'stock_transfer_added_successfully' => 'Inventory transfer added successfully',
	'stock_transfer_delete_success' => 'Inventory transfer deleted successfully',
	'stock_transfer_cannot_be_deleted' => "This inventory transfer can't be deleted as some of the stocks are already sold",
	'total_transfer_shipping_charges' => 'Total Transfer Shipping Charges',
	'enable_inline_tax' => 'Enable inline tax in purchase and sell',
	'save_n_add_opening_stock' => 'Save & Add Opening Inventory',
	'add_opening_stock' => 'Add Opening Inventory',
	'opening_stock_added_successfully' => 'Opening Inventory added successfully',
	'update_n_edit_opening_stock' => 'Update & Edit Opening Inventory',
	'total_amount_exc_tax' => 'Total Amount',
	...
	'item_out_of_stock' => 'Product out of inventory',
	'go_back' => 'Go Back',
	...
	'pending' => 'Pending',
	'ordered' => 'Ordered',
	'search_product_placeholder' => 'Enter Product name',
	'fixed' => 'Fixed',
	'percentage' => 'Percentage',
	'select_location' => 'Select Inventory',
	...
	'purchase_already_exist' => "Product can't be deleted because purchases related to 
								this product exist",
	'opening_stock_sold' => "Product can't be deleted because some inventories are sold",
	'stock_adjusted' => "Product can't be deleted because some inventories are adjusted",
	...
	'default' => 'Default',
	'manage_stock_ins' => 'Enable or disable Inventory managemant',
	'alert_qty_ins' => "Required if Manage Inventory is 1",
    ...
    'purchase_price_exc_tax' => 'Purchase Price',
    'purchase_price_exc_tax_ins1' => 'Required if Purchase Price Including Tax is not given',
    'purchase_price_exc_tax_ins2' => "Purchase Price (Only in numbers)",
   ...
   'opening_stock_ins' => 'Opening Inventory (Only in numbers)',
   'only_applicable_to_single_product' => 'Only applicable to single product',
   'purchase_delete_success' => 'Purchase deleted successfully',
   'location_ins' => "If blank first inventory will be used",
   'location_ins1' => 'Name of the inventory',
   'expiry_date' => 'Expiry Date',
   'expiry_date_ins' => 'Inventory Expiry Date <br><b>Format: mm-dd-yyyy; Ex: 11-25-2018</b>',
   ...
   'tooltip_enable_racks' => 'Enable this to add rack details of a product for different inventories while adding products',
   'rack_details' => 'Rack/Row/Position Details',
   'tooltip_rack_details' => 'Enter details of where the product is kept in the store, for different inventories.',
   'updated_success' => 'Updated Successfully',
   'added_success' => 'Added Successfully',
   'deleted_success' => 'Deleted Successfully',
   'enable_disable_modules' => 'Enable/Disable Modules',
   'opening_stock_help_text' =>"<br><br>For variable products separate inventory quantities with '|' <br>(Ex: 100|150|200)",
   ...
   'you_cannot_edit_this_contact' => 'Can not edit this contact - Transactions already exist for the contact.',
   'you_cannot_delete_this_inventory' => "Cannot delete the inventory - Transactions already exist for the inventory.",
   ...
   'position' => 'Position',
   'weight' => 'Weight',
   'rack_help_text' => "Rack details seperated by '|' for different inventories serially.<br/> (Ex: R1|R5|R12) ",
   'row_help_text' => "Row details seperated by '|' for different inventories serially.<br/> (Ex: ROW1|ROW2|ROW3) ",
   'position_help_text' => "Position details seperated by '|' for different inventories serially.<br/> (Ex: POS1|POS2|POS3) ",
   'import_opening_stock' => 'Import Opening inventory',
   'tooltip_import_opening_stock' => 'This feature is used to import opening inventory of already added products. If the products are not added in the system then it is advisable to use import products for adding product details with opening inventory.',
   'design' => 'Design',
   ...
   'add_edit_opening_stock' => 'Add or edit opening inventory',
   'expiry_date_will_be_changed_in_pl' => 'Expiry date of the purchase line will be changed',
   'remove_from_stock' => 'Remove from inventory',
   'stock_removed_successfully' => 'Inventory removed successfully',
   ...
   'opening_balance_due' => 'Starting Balance Due',
   'contact_person' => 'Contact Person',
   'starting_balance' => 'Starting Balances',
   'regular_balance' => 'Regular Balances',
   'manage_your_starting_balances' => 'Manage your Starting Balances',
   'manage_your_regular_balances' => 'Manage your Regular Balances',
   'debit' => 'Debit',
   'credit' => 'Credit',
   'remaining_starting_balance' => 'Total Remaining',
   'add_regular_balance' => 'Add New Regular Balance',
   'old_loan' => 'Old Loan',
   'retry_after_delete_payment_record' => 'Retry after delete payment records',
   'transaction_sell_record_exist' => 'Transaction sell record exist',
   'recover_expired_items' => 'Recover expired products',
   'recover_expired_items_successfully' => 'Recover expired products successfully',
   'total_loss_expiry' => 'Total Loss of Expiry',
   'product_ref_no' => 'Product Reference NO',
];
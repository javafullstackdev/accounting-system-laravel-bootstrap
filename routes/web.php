...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('/home/get-statistics-details', 'HomeController@getStatisticsDetails');
	...
	Route::post('/contacts/check-contact-name', 'ContactController@checkContactName');
    Route::post('/contacts/check_edit_possiblity', 'ContactController@checkEditPossibility');
    Route::get('/contacts/customers', 'ContactController@getCustomers');
    Route::get('/contacts/starting-balances', 'ContactController@getStartingBalance');

    Route::resource('contacts', 'ContactController');

    Route::post('/regular-balances/check-regular-balance-amount', 'RegularBalanceController@checkRegularBalanceAmount');
    Route::resource('regular-balances', 'RegularBalanceController');
    ...
    Route::get('/products/sold_items_list', 'ProductController@getSoldProductsList');
	...
	Route::post('/products/check_product_name', 'ProductController@checkProductName');
	Route::post('/products/check_ref_no', 'ProductController@checkRefNumber');
    Route::get('/products/quick_add', 'ProductController@quickAdd');
    Route::post('/products/save_quick_product', 'ProductController@saveQuickProduct');
    Route::post('/products/get_currency_rate', 'ProductController@getCurrencyRate');
	...
	Route::get('/sells/create-sale/get_inventory_products', 'SellController@getInventoryProducts');
    Route::resource('sells', 'SellController');

    Route::get('/sells/pos/get_product_row/{variation_id}/{location_id}/{transaction_id}', 'SellPosController@getProductRow');
    Route::get('/sells/pos/get_product_row2/{variation_id}/{location_id}', 'SellPosController@getProductRow2');
	Route::get('/sells/pos/get_product_for_sale', 'SellPosController@getProductForSale');
    ...
    //Currency Rate
    Route::post('/currencies/check-currency', 'CurrencyController@checkCurrency');
    Route::get('/currencies/{id}', 'CurrencyController@getCurrencyRate');
    ...
    //Business Locations...
    Route::post('inventory/check-location-id', 'BusinessLocationController@checkLocationId');
    Route::resource('inventory', 'BusinessLocationController');

    //Bank ...
    Route::resource('bank', 'BankController');
    Route::resource('bank_payment', 'BankPaymentController');
	...
	Route::post('/payments/add_payment/check_bank_balance', 'TransactionPaymentController@checkBankBalance');
	...
	Route::get('/stock-adjustments/recover-expired-stock/{purchase_line_id}', 'StockAdjustmentController@recoverExpiredStock');
    ...
    Route::get('stock-transfers/get_inventory_products', 'StockTransferController@getInventoryProducts');
    Route::get('stock-transfers/get_product_for_transfer', 'StockTransferController@getProductForTransfer');
    ...
    Route::post('sell-return/get_customer_invoices', 'SellReturnController@get_customer_invoices');
